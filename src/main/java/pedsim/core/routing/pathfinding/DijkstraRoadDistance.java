 ...
 * Dijkstra
 * shortest-path algorithm on a primal graph representation of the street
 * network.
 *
...
public class DijkstraRoadDistance extends Dijkstra {
   ...
   * specified origin node to
   * the destination node while considering optional segments to avoid and agent
   * properties.
   *
